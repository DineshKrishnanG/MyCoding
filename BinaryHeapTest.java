...
class BinaryHeap    
{
    ...
    {
    	//System.out.println("inside heapifyUp");
        int tmp = heap[childInd];    
       // System.out.println("childInd["+childInd+"] tmp["+tmp+"]");
        while (childInd > 0 && tmp < heap[parent(childInd)])
        {
            heap[childInd] = heap[ parent(childInd) ];
            childInd = parent(childInd);
            //System.out.println("Swapping heap[childInd] ==>"+heap[childInd]+"   childInd==>"+childInd);
        }                   
        heap[childInd] = tmp;
        //System.out.println("childInd["+childInd+"] heap[childInd]["+tmp+"]");
    }
 
    /** Function heapifyDown **/
    private void heapifyDown(int ind)
    {
    	//System.out.println("inside heapifyDown");
        int child;
        int tmp = heap[ ind ];
